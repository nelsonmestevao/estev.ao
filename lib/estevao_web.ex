defmodule EstevaoWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico humans.txt robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: EstevaoWeb.Router,
        statics: EstevaoWeb.static_paths()
    end
  end
